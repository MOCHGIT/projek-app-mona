export class TodoTypeB extends HTMLElement {
    connectedCallback() {
    this.innerHTML = `

    <link rel="stylesheet" href="./Komponen/CustomComponents/1CSS-CustomComponent/TodoB.css">
    ...
    customElements.define("todo-styleb",TodoTypeB)